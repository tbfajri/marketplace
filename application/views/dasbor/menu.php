<!--  -->
		...
		<ul class="p-b-54">
			...
			<li class="p-t-4">
				<a href="<?php echo base_url('produk/list_user') ?>" class="s-text13 active1">
			...
			<li class="p-t-4">
				<a href="<?php echo base_url('dasbor/list_penjualan') ?>" class="s-text13 active1">
					<i class="fa fa-credit-card"></i> Data Penjualan
				</a>
			</li>	
