				...
				echo '</div>';
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									<td>No Rekening</td>
									<td><input type="text" name="no_rekening" class="form_control" value="<?php echo $pelanggan->no_rekening ?>" placeholder="No Rekening"></input></td>
								</tr>
								<tr>
									<td>Nama Pemilik Rekening</td>
									<td><input type="text" name="nama_pemilik" class="form_control" value="<?php echo $pelanggan->nama_pemilik ?>" placeholder="Nama Pemilik Rekening"></input></td>
								</tr>
								<tr>
									<td>Alamat</td>
