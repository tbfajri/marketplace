<?php 
//  ambil data dari menu konfigurasi
		...
		<div class="wrap_menu">
			<nav class="menu">
				<ul class="main_menu">
					...
					<?php
						//form open cari
					echo form_open_multipart(base_url('home/cari'),' class="form-horizontal"');
					?>
						<li>
						...
						<li class="header-cart-item">
							...
							<div class="header-cart-item-txt">
								...
								<span class="header-cart-item-info">
									<?php echo $keranjang['qty'] ?> x Rp. <?php echo number_format($keranjang['price'], '0',',','.') ?> : Subtotal Rp. <?php echo number_format($keranjang['subtotal'], '0',',','.') ?>
								</span>
							</div>
						</li>
					<?php } // tutup foreach keranjang
						} // tutup if
					 ?>
					</ul>
...
<div class="wrap-side-menu" >
	<nav class="side-menu">
		<ul class="main-menu">
			...
			<li class="item-menu-mobile">
				<a href="<?php echo base_url('kontak') ?>assets/template/contact.html">Contact</a>
			</li>
		</ul>
	</nav>
</div>
