...
<div class="wrap-slick1">
			<div class="slick1">
<?php foreach($kategori_gambar as $kategori_gambar) { ?>
		<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(<?php echo base_url('assets/upload/image/'.$kategori_gambar->gambar) ?>">
...
<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
			...
			echo form_hidden('id_penjual', $produk->id_penjual);
			echo form_hidden('nama_toko', $produk->nama_toko);
